...
bm25_pos = pyplot.bar(index, system_pos['BM25'],bar_width,alpha=opacity,color='g',label='BM25')
bm25_neg = pyplot.bar(index, system_neg['BM25'],bar_width,alpha=opacity,color='g')
...
pyplot.ylim((-0.5,0.5))
pyplot.xlabel('Preprocessing approach')
pyplot.ylabel('Improved and worsened rankings compared to no preprocessing')
