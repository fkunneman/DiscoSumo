...
def run_kernel(smoothed, vector, tree, evaluation_path, kernel_path):
    model = SemevalTreeKernel(smoothed=smoothed, vector=vector, tree=tree, kernel_path=kernel_path)
